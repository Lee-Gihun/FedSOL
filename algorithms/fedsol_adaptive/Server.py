...
from algorithms.fedsol_adaptive.ClientTrainer import ClientTrainer
...
class Server(BaseServer):
    def __init__(
        ...
        print("\n>>> FedSOL (Adaptive Rho) Server initialized...\n")
    ...
    def _clients_training(self, sampled_clients, finetune=False):
        ...
        for client_idx in sampled_clients:
            ...
            # Download global
            self.client.download_global(server_weights, server_optimizer, self.rho)
